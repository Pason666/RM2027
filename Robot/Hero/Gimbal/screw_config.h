...
constexpr uint32_t DYNAMIC_CALIB_WINDOW_TICKS = 200; // 动态校准的观察窗口期

// =========================================================
// 动态校准触发阈值 (防零漂判定条件)
// =========================================================
constexpr float CALIB_PITCH_STILL_RADPS = 0.03f; // Pitch IMU 角速度极小判定
constexpr float CALIB_ROLL_LEVEL_RAD    = 0.05f; // Roll 水平判定
constexpr float CALIB_PITCH_ERROR_RAD   = 0.02f; // 当前与目标误差极小判定
constexpr float CALIB_MOTOR_STILL_RADPS = 0.03f; // Pitch 电机角速度极小判定
...
constexpr float YAW_SLING_FRICTION_TORQUE     = 0.35f; // 吊射模式 Yaw 摩擦前馈
